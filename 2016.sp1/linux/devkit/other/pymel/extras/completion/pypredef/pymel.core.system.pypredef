...
def ogs(*args, **kwargs):
    ...
    Flags:
      - deviceInformation : di         (bool)          [create]
          If used then output the current device information.                                       Flag can have multiple
...
def scriptNode(*args, **kwargs):
    ...
    Flags:
      ...
      - ignoreReferenceEdits : ire     (bool)          [create]
          ...
          recorded as edits by default.                          Flag can have multiple arguments, passed either as a tuple or a
          list.
...
def namespaceInfo(*args, **kwargs):
    ...
    Flags:
      ...
      - internal : int                 (bool)          [create]
          ...
          include internal nodes (for example itemFilters) that are not listed by default.                        Flag can have
          multiple arguments, passed either as a tuple or a list.
...
def moduleInfo(*args, **kwargs):
    ...
    Flags:
      ...
      - moduleName : mn                (unicode)       [create]
          ...
          flags.                                           Flag can have multiple arguments, passed either as a tuple or a list.
...
def profilerTool(*args, **kwargs):
    ...
    Flags:
      ...
      - segmentCount : sc              (bool)          [query]
          Returns the number of segments in the event buffer.                                       Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def fileDialog2(*args, **kwargs):
    ...
    Flags:
      ...
      - optionsUICommit : ocm          (unicode)       [create]
          ...
          the parent layout into which controls have been added using the optionsUICreate flag.                          Flag can
...
def whatsNewHighlight(*args, **kwargs):
    ...
    Flags:
      ...
      - showStartupDialog : ssd        (bool)          [create,query]
          Set whether the settings dialog for this feature appears on startup.                      Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def dgdirty(*args, **kwargs):
    ...
    Flags:
      ...
      - verbose : v                    (bool)          [create,query]
          Prints out all of the plugs being set dirty on stdout.                                    Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def dgeval(*args, **kwargs):
    ...
    Flags:
      - src : src                      (bool)          [create]
          This flag is obsolete. Do not use.                        Flag can have multiple arguments, passed either as a tuple or
          a list.
...
def dgfilter(*args, **kwargs):
    ...
    Flags:
      ...
      - name : n                       (unicode)       [create]
          ...
          filter will be returned.                                    Flag can have multiple arguments, passed either as a tuple
          or a list.
...
def pluginInfo(*args, **kwargs):
    ...
    Flags:
      ...
      - writeRequires : wr             (bool)          [create,query,edit]
          ...
          attributes. For example, stereoCamerais using this flag for its customized UI.
...
def dbtrace(*args, **kwargs):
    ...
    Flags:
      - filter : f                     (unicode)       [create,query]
          Set the filter object for these trace objects (see 'dgfilter')                                    Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def namespace(*args, **kwargs):
    ...
    Flags:
      ...
      - collapseAncestors : ch         (unicode)       [create]
          ...
          or other nested namespaces                       Flag can have multiple arguments, passed either as a tuple or a list.
...
def unknownPlugin(*args, **kwargs):
    ...
    Flags:
      ...
      - remove : r                     (bool)          [create]
          ...
          defined by the plug-in are still in use.                          Flag can have multiple arguments, passed either as a
          tuple or a list.
...
def filePathEditor(*args, **kwargs):
    ...
    Flags:
      ...
      - preview : p                    (bool)          [create]
          ...
          the command returns the files which need copying.
...
def profiler(*args, **kwargs):
    ...
    Flags:
      ...
      - clearAllMelInstrumentation : cam (bool)          [create]
          Clear all MEL command or procedure instrumentation.                                       Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def pluginDisplayFilter(*args, **kwargs):
    ...
    Flags:
      ...
      - listFilters : lf               (bool)          [query]
          Returns an array of all plugin display filters.                                           Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def internalVar(*args, **kwargs):
    ...
    Flags:
      ...
      - userHotkeyDir : uhk            (bool)          [create]
          Return the user hotkey directory.                         Flag can have multiple arguments, passed either as a tuple or
          a list.
...
def translator(*args, **kwargs):
    ...
    Flags:
      - defaultFileRule : dfr          (unicode)       [query]
          Returns the default file rule value, can return as well                   Flag can have multiple arguments, passed
          either as a tuple or a list.
...
def unknownNode(*args, **kwargs):
    ...
    Flags:
      ...
      - realClassTag : rct             (bool)          [query]
          Return the real class IFF tag of the node.                        Flag can have multiple arguments, passed either as a
          tuple or a list.
