...
def illustratorCurves(*args, **kwargs):
    ...
    Flags:
      ...
      - name : n                       (unicode)       [create]
          ...
          namespace; if the namespace does not exist, it will be created.                          Flag can have multiple
...
def polyOptions(*args, **kwargs):
    ...
    Flags:
      ...
      - smoothDrawType : sdt           (int)           [create,query]
          ...
          Clark Adaptive                     Flag can have multiple arguments, passed either as a tuple or a list.
...
def manipOptions(*args, **kwargs):
    ...
    Flags:
      ...
      - hideManipOnShiftCtrl : hsc     (bool)          [create,query]
          Hide transform manip when the Shift and Ctrl keys are both pressed.                       Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def transferShadingSets(*args, **kwargs):
    ...
    Flags:
      ...
      - searchMethod : sm              (int)           [create,query,edit]
          ...
          default is closest to point.                                          Flag can have multiple arguments, passed either as
          a tuple or a list.
...
def polyReduce(*args, **kwargs):
    ...
    Flags:
      ...
      - triangulate : t                (bool)          [create,query,edit]
          ...
          Q: When queried, this flag returns a boolean.                    Common flags
...
def geomToBBox(*args, **kwargs):
    ...
    Flags:
      ...
      - startTime : st                 (time)          [create]
          Used with bakeAnimation flag. Specifies the start time of the baking process.                                     Flag
          can have multiple arguments, passed either as a tuple or a list.
...
def dataStructure(*args, **kwargs):
    ...
    Flags:
      - asFile : af                    (unicode)       [create,query]
          ...
          the 'format' flag.                                        Flag can have multiple arguments, passed either as a tuple or
          a list.
...
def polyPinUV(*args, **kwargs):
    ...
    Flags:
      ...
      - value : v                      (float)         [create,query,edit]
          ...
          respectively to the specified UVs.
...
def polyRemesh(*args, **kwargs):
    ...
    Flags:
      ...
      - reduceThreshold : rdt          (float)         [create,query,edit]
          Reduction threshold                       Flag can have multiple arguments, passed either as a tuple or a list.
...
def manipPivot(*args, **kwargs):
    ...
    Flags:
      ...
      - snapOri : so                   (bool)          [create,query]
          Snap pivot orientation. Modify pivot orientation when snapping the pivot to a component.                          Flag
          can have multiple arguments, passed either as a tuple or a list.
...
def filterExpand(*args, **kwargs):
    ...
    Flags:
      ...
      - symSeam : sms                  (bool)          [create]
          ...
          symmetry plane. This flag has no effect if symmetry is not active.                         Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def showMetadata(*args, **kwargs):
    ...
    Flags:
      ...
      - isActivated : ia               (bool)          [create,query]
          ...
          selected, query the states of all shapes in the scene.                                    Flag can have multiple
          arguments, passed either as a tuple or a list.
    ...
    by the flags) [create,query]
      ...
      - stream : s                     (unicode)       [create,query]
          ...
          each shape can be visualized at a time. In query mode, this flag can accept a value.
...
def polyContourProjection(*args, **kwargs):
    ...
    Flags:
      ...
      - userDefinedCorners : udc       (bool)          [create,query,edit]
          If true, the four vertices specified by user will be taken as corners to do the projection.                       Common
          flags
...
def applyMetadata(*args, **kwargs):
    ...
    Flags:
      ...
      - value : v                      (unicode)       [create]
          String containing all of the metadata to be assigned to the selected object.                                      Flag
          can have multiple arguments, passed either as a tuple or a list.
