...
def texTweakUVContext(*args, **kwargs):
    ...
    Flags:
      ...
      - tolerance : t                  (bool)          [create,query,edit]
          Controls the initial selection snapping tolerance.                        Flag can have multiple arguments, passed
          either as a tuple or a list.
...
def manipScaleContext(*args, **kwargs):
    ...
    Flags:
      ...
      - scale : sc                     (float, float, float) [query,edit]
          Returns the scale of the manipulator for its current orientation/mode.                    Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def manipMoveContext(*args, **kwargs):
    ...
    Flags:
      ...
      - translate : tr                 (float, float, float) [query,edit]
          Returns the translation of the manipulator for its current orientation/mode.                      Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def ctxEditMode(*args, **kwargs):
    ...
    Flags:
      ...
      - buttonUp : btu                 (bool)          [create]
          Edit mode is being invoked from a hotkey release event.                   Flag can have multiple arguments, passed
          either as a tuple or a list.
...
def jointCtx(*args, **kwargs):
    ...
    Flags:
      ...
      - smallBoneRadius : sbr          (float)         [create,query,edit]
          Specifies the radius for bones whose length is below the smallBoneLength.                         Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def graphSelectContext(*args, **kwargs):
    ...
    Flags:
      ...
      - image3 : i3                    (unicode)       [create,query,edit]
          Third of three possible icons representing the tool associated with the context.                          Flag can have
          multiple arguments, passed either as a tuple or a list.
...
def retimeKeyCtx(*args, **kwargs):
    ...
    Flags:
      ...
      - moveByFrame : mbf              (int)           [edit]
          Move the selected retime bar by the specified number of frames                    Flag can have multiple arguments,
...
def hotkeyCtx(*args, **kwargs):
    ...
    Flags:
      ...
      - removeAllClients : rac         (bool)          [create]
          ...
          specifies the context type.                     Flag can have multiple arguments, passed either as a tuple or a list.
...
def texCutContext(*args, **kwargs):
    ...
    Flags:
      ...
      - displayShellBorders : dsb      (bool)          [query,edit]
          Toggle the display of shell borders.                      Flag can have multiple arguments, passed either as a tuple or
          a list.
...
def manipRotateContext(*args, **kwargs):
    ...
    Flags:
      ...
      - rotate : ro                    (float, float, float) [query,edit]
          Returns the rotation of the manipulator for its current orientation/mode.                         Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def sculptMeshCacheCtx(*args, **kwargs):
    ...
    Flags:
      ...
      - frame : frm                    (bool)          [create,edit]
          Frames on the sculpted area                       Flag can have multiple arguments, passed either as a tuple or a list.
...
def texSculptCacheContext(*args, **kwargs):
    ...
    Flags:
      ...
      - showBrushRingDuringStroke : sbr (int)           [query,edit]
          Specifies whether or not to show the brush ring during stroke.                    Flag can have multiple arguments,
          passed either as a tuple or a list.
