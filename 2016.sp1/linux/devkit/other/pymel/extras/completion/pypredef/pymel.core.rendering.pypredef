...
def ogsRender(*args, **kwargs):
    ...
    Flags:
      ...
      - activeRenderTargetFormat : fpt (unicode)       [query,edit]
          Query the current active floating point target format.                                    Flag can have multiple
...
def prepareRender(*args, **kwargs):
    ...
    Flags:
      ...
      - traversalSetInit : tsi         (script)        [query,edit]
          ...
          whenever the specified traversal set becomes the default. traversal set.                                      Flag can
...
def textureWindow(*args, **kwargs):
    ...
    Flags:
      ...
      - capture : cpt                  (bool)          [edit]
          Perform a one time capture of the viewport to a image file on disk.
      ...
      - captureSequenceNumber : csn    (int)           [edit]
          ...
          used for the capture flag arguent. The value of # starts at the number specified to for this argument and increments for
          each subsequent refresh.  Sequence capture can be disabled by specifying a number less than 0 or an empty file name for
          the capture flag.
      ...
      - viewTransformName : vtn        (unicode)       [query,edit]
          Sets the view pipeline to be applied if color management is enabled in the current editor.                        Flag
...
def rampColorPort(*args, **kwargs):
    ...
    Flags:
      ...
      - verticalLayout : vl            (bool)          [create,query,edit]
          Set the preview's layout.                         Flag can have multiple arguments, passed either as a tuple or a list.
...
def getRenderTasks(*args, **kwargs):
    ...
    Flags:
      ...
      - renderLayer : rl               (unicode)       [create]
          Render layer to use in the render context for the image source render task.                                       Flag
          can have multiple arguments, passed either as a tuple or a list.
...
def track(*args, **kwargs):
    ...
    (<function track at 0x14565bd70>, <function addCmdDocsCallback at 0x1454f7b18>, ('track', ''), {})
...
def perCameraVisibility(*args, **kwargs):
    ...
    Flags:
      ...
      - removeAll : ra                 (bool)          [create]
          Remove all exclusivity/hidden objects for all cameras.                                    Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def shadingNode(*args, **kwargs):
    ...
    Flags:
      ...
      - isColorManaged : icm           (bool)          [create]
          classify the current DG node as being color managed                       Flag can have multiple arguments, passed
          either as a tuple or a list.
...
def renderWindowEditor(*args, **kwargs):
    ...
    Flags:
      ...
      - viewTransformName : vtn        (unicode)       [query,edit]
          Sets/gets the view transform to be applied if color management is enabled in the current view.                    Flag
          can have multiple arguments, passed either as a tuple or a list.
...
def imagePlane(*args, **kwargs):
    ...
    Flags:
      ...
      - detach : d                     (bool)          [edit]
          ...
          camera it attaches to and make it a free image plane.                                    Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def tumble(*args, **kwargs):
    ...
    (<function tumble at 0x14565e410>, <function addCmdDocsCallback at 0x1454f7b18>, ('tumble', ''), {})
...
def soloMaterial(*args, **kwargs):
    ...
    Flags:
      ...
      - last : l                       (bool)          [create,query]
          Whether to solo the last material node and attribute.                                     Flag can have multiple
          arguments, passed either as a tuple or a list.
...
def renderer(*args, **kwargs):
    ...
    Flags:
      ...
      - materialViewRendererList : mvl (bool)          [query,edit]
          Returns the names of material view renderers that are currently registered.                                       Flag
          can have multiple arguments, passed either as a tuple or a list.
...
def orbit(*args, **kwargs):
    ...
    (<function orbit at 0x1456387d0>, <function addCmdDocsCallback at 0x1454f7b18>, ('orbit', ''), {})
...
def convertSolidTx(*args, **kwargs):
    ...
    Flags:
      ...
      - pixelFormat : pf               (unicode)       [create]
          ...
          8 bits per channel, unsigned (0-255) 16: 16 bits per channel, unsigned (0-65535) Default is 8.                   Flag
          can have multiple arguments, passed either as a tuple or a list.
