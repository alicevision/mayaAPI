...
class PyDagItr(MayaToPyItr):
    ...
    def __init__(self, mit_dag="<maya.OpenMaya.MItDag; proxy of <Swig Object of type 'MItDag *' at 0x1499b5540> >"):
        pass
...
class PyDepNodesItr(PyDepGraphItr):
    ...
    def __init__(self, mit_dependency_nodes="<maya.OpenMaya.MItDependencyNodes; proxy of <Swig Object of type 'MItDependencyNodes *' at 0x1499da720> >", filter=0, miterator_type=None):
        """
