...
def expression(*args, **kwargs):
    ...
    Flags:
      ...
      - timeDependent : td             (unicode)       [query]
          ...
          is on. Otherwise time change will dirty the expression.                       Flag can have multiple arguments, passed
          either as a tuple or a list.
      ...
      - unitConversion : uc            (unicode)       [query,edit]
          ...
          tuning. If queried, returns the option used when the expression was created or last edited.
...
def dynExport(*args, **kwargs):
    ...
    Flags:
      ...
      - format : f                     (unicode)       [create]
          ...
          on.                      Flag can have multiple arguments, passed either as a tuple or a list.
