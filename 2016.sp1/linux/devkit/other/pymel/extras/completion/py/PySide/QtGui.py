from PySide.QtCore import QEventTransition as _QEventTransition
from PySide.QtCore import QCoreApplication as _QCoreApplication
from PySide.QtCore import QAbstractItemModel as _QAbstractItemModel
from PySide.QtCore import QAbstractListModel as _QAbstractListModel
...
class QAbstractProxyModel(_QAbstractItemModel):
    def __init__(*args, **kwargs):
        """
        x.__init__(...) initializes x; see help(type(x)) for signature
        """
...
class QProxyModel(_QAbstractItemModel):
    def __init__(*args, **kwargs):
        """
        x.__init__(...) initializes x; see help(type(x)) for signature
        """
